"""
Розрахунок вартості за USAGE["by_model"] з core/agent.py.

Ціни — за мільйон токенів, станом на 2026-08 (той самий довідник, що й у
module1/core/cost.py — ті самі моделі). Правити тут, якщо змінились.
"""
